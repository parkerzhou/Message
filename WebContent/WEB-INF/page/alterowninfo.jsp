...
<body background="resources/img/bodybackground19.jpg">
<h1 align="center">留言板系统</h1>
<div align="center">
	<div class="easyui-panel" title="修改个人信息" style="width:500px;">
	    ...
	    <form id="ff" method="post" action="Register_save">
	    	<table cellpadding="5">
	    		<tr>
	    		<div id="divdis" style="color:#FF0000" name="a"></div>
	    			<td style="font-weight:bold;font-size:15px;">用户名:</td>
	    			<td><input id="name" class="easyui-validatebox" missingMessage="用户名必须填写" type="text" name="user.user_name" required="true" onblur="check()" value="${user.user_name }"></input></td>
	    			<td></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			...
	    			<td><input class="easyui-validatebox" missingMessage="邮箱必须填写" type="text" name="user.user_mail" required="true" validType="email" value="${user.user_mail }"></input></td>
