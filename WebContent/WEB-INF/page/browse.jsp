...
<body>
 <div class="easyui-layout" style="width:100%;height:595px;">
   ...
   <%if(user==null){ %>
    <div align="left" style="font-size: 20px; padding-right: 20px">欢迎你!</div>
    <%} else{%>
    <div align="left" style="font-size: 20px; padding-right: 20px">欢迎你!<%=user.getUser_name() %></div>
    <%} %>
    <p align="center" style="font-size: 30px;font-weight:bolder ;">留言板系统</p>
  </div>
  <div region="west" split="true" title="功能" style="width:272px;background:url('resources/img/bodybackground5.jpg'); padding-top: 30px">
  <%
  if(user==null){
  %>
       <div align="center" style="padding-top: 10px"><a href="adminlogin">管理员登录</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
       <div align="center" style="padding-top: 10px"><a href="login">用户登录</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
	   <div align="center" style="padding-top: 10px"><a href="register">注册</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
	   <%}else{ %>
	   <div align="center" style="padding-top: 10px"><a href="Browse_exit">退出</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
	   <div align="center" style="padding-top: 10px"><a href="Browse_checkOwnMess">查看个人留言</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
	   <div align="center" style="padding-top: 10px"><a href="owninfo">查看个人信息</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
	   <%} %>
	   <div align="center" style="padding-top: 10px"><a href="addmessage">添加留言</a></div><hr noshade color="#8E8E8E" width="150px" align="center">
  </div>
  <div id="content" region="center" >
  <div class="easyui-tabs" style="width:px;height:444px;">
